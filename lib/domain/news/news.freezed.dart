...
class _$_News implements _News {
  ...
  @override
  String toString() {
    return 'News(author: $author, title: $title, description: $description, url: $url, urlToImage: $urlToImage, content: $content, publishedAt: $publishedAt)';
  }
...
abstract class _News implements News {
  const factory _News(
      ...
      required final DateTime? publishedAt}) = _$_News;
